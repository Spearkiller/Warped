...
public class ItemAbyssalMirror extends AbstractMirror {
    ...
    public ItemAbyssalMirror(Properties pProperties, int blocks, int max_cost, boolean xDimension){
        super(pProperties, blocks, max_cost, xDimension, DUST_ABYSSAL_MIRROR);
    }
